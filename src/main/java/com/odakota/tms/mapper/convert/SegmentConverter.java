 ...
 */
@Converter
public class SegmentConverter implements AttributeConverter<Segment, Integer> {
     ...
     */
    @Override
    public Integer convertToDatabaseColumn(Segment attribute) {
     ...
     */
    @Override
    public Segment convertToEntityAttribute(Integer dbData) {
        return Segment.of(dbData);
    }
}
