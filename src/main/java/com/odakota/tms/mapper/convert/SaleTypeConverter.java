 ...
 */
@Converter
public class SaleTypeConverter implements AttributeConverter<SaleType, Integer> {
     ...
     */
    @Override
    public Integer convertToDatabaseColumn(SaleType attribute) {
     ...
     */
    @Override
    public SaleType convertToEntityAttribute(Integer dbData) {
        return SaleType.of(dbData);
    }
}
