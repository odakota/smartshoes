 ...
 */
@Service
public class ExportService<E extends BaseEntity> {

    private final ExcelExport<E> excelExport;
    ...
    @Autowired
    public ExportService(ExcelExport<E> excelExport, RoleRepository roleRepository,
