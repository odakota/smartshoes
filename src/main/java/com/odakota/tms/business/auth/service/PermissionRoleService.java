...
public class PermissionRoleService extends BaseService<PermissionRole, PermissionRoleResource, PermissionRoleCondition> {
    ...
    public void saveRolePermissions(PermissionRoleResource resource) {
        String[] preIds = "".equals(resource.getLastPermissionIds()) ? new String[0] :
                          resource.getLastPermissionIds().split(",");
        String[] newIds = "".equals(resource.getPermissionIds()) ? new String[0] :
                          resource.getPermissionIds().split(",");
