...
public class LoginController {
     ...
     */
    @RequiredAuthentication
    @ApiOperation("API change my password")
    @PutMapping(value = "/change-password", produces = ApiVersion.API_VERSION_1)
    public ResponseEntity<?> changePassword(@RequestBody ResetPasswordResource resetPasswordResource) {
        loginService.changePassword(resetPasswordResource);
        return ResponseEntity.noContent().build();
    }
}
